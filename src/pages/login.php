    ...
    <div class="max-w-2xl  mx-auto  my-12 bg-white p-8 pb-1 mt-16 rounded-xl shadow shadow-slate-200 drop-shadow-lg dark:bg-mainColorDark dark:shadow-slate-900 sm: w-full">
        ...
        <form action="" class="my-10">
            <div class="flex flex-col space-y-5">
                ...
                <label for="password">
                    <input id="password" name="password" type="password" class="w-full py-3 border-gray-300 border-2 rounded-lg px-3 focus:outline-none focus:border-mainBlue" placeholder="Enter your password">
                </label>
