...
<body class="font-poppins dark:bg-gray-900 text-mainBlue dark:text-white">
        ...
        <div class="modal__container fixed flex z-10 justify-center items-center transition-[0.3s] duration-[ease-in-out] opacity-0 left-2/4 top-2/4">
            <div class="modal flex flex-col justify-center items-center max-w-screen-sm min-w-[28rem] bg-white shadow shadow-slate-200 drop-shadow-lg dark:bg-mainColorDark dark:shadow-slate-900 rounded-lg p-6 gap-2">
              <div class="modal__header flex justify-between items-center w-full text-[#FE8D4D] font-bold first-letter:font-family: system-ui, -apple-system, BlinkMacSystemFont">
                <h2 class="modal__title font-poppins text-xl">Edit User</h2>
              ...
              <div class="modal__body flex flex-col justify-center items-start text-slate-50 gap-2 w-[100%]">
                ...
                <div>
                  ...
                  <input type="text" id="username" class="flex w-[100%] py-3 border-gray-300 border-2 rounded-lg px-3 focus:outline-none focus:border-mainBlue dark:focus:border-mainPurple text-defaultText" placeholder="Username">
                </div>
                  <div>
                    <label for="phone"></label>
                  <input type="text" id="phone" class="flex w-[100%] py-3 border-gray-300 border-2 rounded-lg px-3 focus:outline-none focus:border-mainBlue dark:focus:border-mainPurple text-defaultText" placeholder="Phone">
                  </div>
                  </div>
                  <label for="email"></label>
                  <input type="text" id="email" class="flex w-[100%] py-3 border-gray-300 border-2 rounded-lg px-3 focus:outline-none focus:border-mainBlue dark:focus:border-mainPurple text-defaultText" placeholder="Email">
                  <label for="dob"></label>
                  <input type="text" id="dob" class="flex w-[100%] py-3 border-gray-300 border-2 rounded-lg px-3 focus:outline-none focus:border-mainBlue dark:focus:border-mainPurple text-defaultText" placeholder="Date of birth">
                  <label for="city"></label>
                  <input type="text" id="city" class="flex w-[100%] py-3 border-gray-300 border-2 rounded-lg px-3 focus:outline-none focus:border-mainBlue dark:focus:border-mainPurple text-defaultText" placeholder="City">
                </form>
              </div>
              <div class="modal__buttons flex justify-end gap-2 items-center text-base">
                <button type="button" class="modal__button__footer__close dark:bg-mainPurple bg-mainBlue text-white cursor-pointer px-4 py-[0.7rem] rounded-[5px] border-none">
                  Submit
                </button>
              </div>
            </div>
    ...
    <!-- <button type="button" class="focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900" id="addUser">Add User</button> -->
        </div>
...
const deleteUser = async (id) => {
  try {
    const response = await fetch(`http://localhost/backend/users.php?id=${id}`, {
      method: "DELETE",
    });
...
const initializeTable = (data) => {
  const table = new DataTable("#table_id", {
    ...
    columns: [
      ...
      { data: "city" },
      {
        data: null,
        defaultContent:
          '<div class="flex gap-2"><button type="button" class="focus:outline-none text-white dark:bg-purple-700 bg-blue-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900 addUser">Edit</button><button type="button" class="focus:outline-none text-white bg-[#FE8D4D] hover:bg-[#F18040] focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:focus:ring-[#F18040] deleteButton">Delete</button></div>',
      },
    ],
  });

  const deleteButtons = document.querySelectorAll(".deleteButton");
  const editUserButtons = document.querySelectorAll(".addUser");
  ...
  const handleDeleteButtonClick = async(event) => {
    const id =
      ...
      const editUserButtons = document.querySelectorAll(".addUser");
      modal && editUserButtons.forEach(editUserButton => {
...
while (i >= 0) {
  if (i === 2) {
    [content[i].textContent, content[i + 1].textContent] = [content[i + 1].textContent, content[i].textContent];
  }
