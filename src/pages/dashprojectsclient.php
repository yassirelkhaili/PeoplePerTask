...
<body class="font-poppins dark:bg-gray-900 text-mainBlue dark:text-white">
    <section class="flex flex-row">
        <side class="hidden md:block dark:bg-indigo-950 dark:border-none text-base rounded-3xl w-[25%]  py-[1%] px-[1%]  border">
            <div class="mb-[15%]">
                <img src="../../images/Link_logo.svg.svg" alt="logo">
            </div>
            <ul class=" ml-[2%] mb-[10%] text-lg">
              <li class="flex p-3 mb-15 w-3/4 h-14 transition-transform duration-200 ease-out transform-colors dark:hover:bg-purple-700  hover:scale-110 rounded mb-[10%]">
                <svg xmlns="http://www.w3.org/2000/svg" width="27" height="20" viewBox="0 0 27 20" fill= "#6366F1" class="dark:fill-white">
                    <g clip-path="url(#clip0_817_33)">
                    <path d="M26.2896 13.2302H23.9324C23.54 13.2302 23.2219 13.4658 23.2219 13.7565V17.9242C23.2219 18.2148 23.54 18.4505 23.9324 18.4505H26.2896C26.6819 18.4505 27 18.2148 27 17.9242V13.7565C27 13.4658 26.682 13.2302 26.2896 13.2302Z" />
                    <path d="M20.4841 11.2291H18.1269C17.7345 11.2291 17.4164 11.4647 17.4164 11.7554V17.9242C17.4164 18.2148 17.7344 18.4504 18.1269 18.4504H20.4841C20.8764 18.4504 21.1945 18.2148 21.1945 17.9242V11.7554C21.1946 11.4647 20.8765 11.2291 20.4841 11.2291Z" />
                    <path d="M8.87318 13.2302H6.51597C6.12361 13.2302 5.80554 13.4658 5.80554 13.7565V17.9242C5.80554 18.2148 6.12361 18.4505 6.51597 18.4505H8.87318C9.26554 18.4505 9.58366 18.2148 9.58366 17.9242V13.7565C9.58366 13.4658 9.26554 13.2302 8.87318 13.2302Z" />
                    <path d="M3.06769 11.2291H0.710486C0.318069 11.2291 0 11.4647 0 11.7554V17.9242C0 18.2148 0.318069 18.4505 0.710486 18.4505H3.06769C3.46005 18.4505 3.77812 18.2149 3.77812 17.9242V11.7554C3.77812 11.4647 3.46005 11.2291 3.06769 11.2291Z"/>
                    <path d="M14.6787 8.56848H12.3214C11.9291 8.56848 11.611 8.80409 11.611 9.09477V17.9242C11.611 18.2149 11.929 18.4505 12.3214 18.4505H14.6787C15.071 18.4505 15.3891 18.2149 15.3891 17.9242V9.09477C15.3891 8.80409 15.071 8.56848 14.6787 8.56848Z"/>
                    <path d="M25.6562 10.6414C26.1342 10.6414 26.5371 10.3529 26.5371 9.98892V7.87999C26.5371 7.51962 26.1427 7.22746 25.6562 7.22746C25.1697 7.22746 24.7753 7.51962 24.7753 7.87999V8.40719L15.8282 1.742C15.6433 1.60432 15.3856 1.53463 15.1241 1.55225C14.863 1.56978 14.626 1.67253 14.4775 1.83262L7.737 9.09996L1.81709 6.30644C1.40676 6.11281 0.862177 6.20221 0.60084 6.5062C0.339443 6.81015 0.460129 7.2135 0.870517 7.40712L7.50797 10.5393C7.65449 10.6084 7.8184 10.6415 7.98049 10.6415C8.26138 10.6415 8.53693 10.5421 8.7073 10.3585L15.328 3.22024L23.5379 9.33639H22.8091C22.3226 9.33639 21.9282 9.62855 21.9282 9.98892C21.9282 10.3493 22.3226 10.6414 22.8091 10.6414C23.2032 10.6414 25.2551 10.6414 25.6541 10.6414H25.6562Z"/>
                    </g>
                    <defs>
                ...
                <li>
                    <button type="button" id="checkbox-wrapper">
                            <label class="text-[17px] relative inline-block w-[3.5em] h-[2em]">
                                ...
                                <span class="slider bg-white absolute cursor-pointer border transition duration-300 rounded-[30px] border-solid border-[#adb5bd] inset-0 before:absolute before:content-[''] before:h-[1.4em] before:w-[1.4em] before:bg-[#FE8D4D] before:transition before:duration-300 before:rounded-[20px] before:left-[0.27em] before:bottom-[0.25em]"></span>
                              </label>
                    </button>
                </li>
            </ul>
            <div class="flex flex-row ml-[4%]  my-[40%]">
                <div class="rounded-[50%] bg-slate-400 mr-[7%]">
                    <img class="rounded-[50%]" src="../../images/young man in formalwear standing with hands on hip.svg" alt="freelencer">
                </div>
          ...
          <nav class="flex flex-row justify-between items-center p-[1%]">
            <div class="text-black dark:text-white">
                ...
                <div class="hidden md:block">
                  <div id="search" class="flex flex-row justify-between text-xs border-4 w-72 rounded-3xl p-1 dark:bg-indigo-950 dark:border-none">
        ...
        <div class="modal__container fixed flex z-10 justify-center items-center transition-[0.3s] duration-[ease-in-out] opacity-0 left-2/4 top-2/4">
                ...
                <div>
                  ...
                  <div class="w-[100%]">
                   ...
                   <select name="sub_categoryID" id="selectuserID" data-sub_categories class="flex w-[100%] py-3 border-gray-300 border-2 rounded-lg px-3 focus:outline-none focus:border-mainBlue dark:focus:border-mainPurple text-defaultText">
                    <option disabled>select sub_category</option>
                  </select>
                  </div>
                  <div class="w-[100%]">
                    <label for="selectuserID"></label>
          ...
          <div class="modal__container modalDelete fixed flex z-10 justify-center items-center transition-[0.3s] duration-[ease-in-out] opacity-0 left-2/4 top-2/4">
            <div class="flex flex-col justify-center items-center max-w-screen-sm min-w-[28rem] bg-white shadow shadow-slate-200 drop-shadow-lg dark:bg-mainColorDark dark:shadow-slate-900 rounded-lg p-6">
              <div class="modal__header flex justify-between items-center w-full text-[#FE8D4D] font-bold first-letter:font-family: system-ui, -apple-system, BlinkMacSystemFont">
                <h2 class="modal__title font-poppins text-xl">Delete Project</h2>
                <button type="button" class="modal__button__close__delete cursor-pointer p-[1rem]">
                    <svg xmlns='http://www.w3.org/2000/svg' height="20px" width="20px" viewBox='0 0 16 16' fill='#FFFFFF'><path d='M.293.293a1 1 0 011.414 0L8 6.586 14.293.293a1 1 0 111.414 1.414L9.414 8l6.293 6.293a1 1 0 01-1.414 1.414L8 9.414l-6.293 6.293a1 1 0 01-1.414-1.414L6.586 8 .293 1.707a1 1 0 010-1.414z'/></svg>
                </button>
              </div>
              <hr>
              <div class="modal__body flex flex-col justify-center items-start text-slate-50 w-[100%] gap-2">
                <div class="p-4">
                  <p>Click Delete to Confirm This Action</p>
                </div>
                  <di class="modal__buttons flex justify-center gap-2 items-center text-base">
                <button type="submit" class="modal__button__footer__close__delete dark:bg-mainPurple bg-mainBlue text-white cursor-pointer px-4 py-[0.7rem] rounded-[5px] border-none deleteAction">
                  Delete
                </button>
              </div>
            </div>
        ...
        <div class="hidden md:block">
          <nav class="bg-mainBlue dark:bg-purple-500 text-xl bg-opacity-75 p-4 text-mainBlue dark:text-purple-500 font-bold rounded-md h-[6%] flex flex-row items-center gap-5">                    
            <div class="flex flex-row gap-2 justify-center items-center bg-white rounded-3xl text-center ml-[7%] w-[15%] h-10 transition-transform duration-200 ease-out hover:scale-110">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 20 20" fill="none">
                        <path d="M18.3333 7.1V3.31666C18.3333 2.14166 17.8 1.66666 16.475 1.66666H13.1083C11.7833 1.66666 11.25 2.14166 11.25 3.31666V7.09166C11.25 8.275 11.7833 8.74166 13.1083 8.74166H16.475C17.8 8.75 18.3333 8.275 18.3333 7.1Z" fill="#6366F1" class="dark:fill-purple-500 bg-opacity-75 p-4"/>
                        <path d="M18.3333 16.475V13.1083C18.3333 11.7833 17.8 11.25 16.475 11.25H13.1083C11.7833 11.25 11.25 11.7833 11.25 13.1083V16.475C11.25 17.8 11.7833 18.3333 13.1083 18.3333H16.475C17.8 18.3333 18.3333 17.8 18.3333 16.475Z" fill="#6366F1" class="dark:fill-purple-500 bg-opacity-75 p-4"/>
                        <path d="M8.74984 7.1V3.31666C8.74984 2.14166 8.2165 1.66666 6.8915 1.66666H3.52484C2.19984 1.66666 1.6665 2.14166 1.6665 3.31666V7.09166C1.6665 8.275 2.19984 8.74166 3.52484 8.74166H6.8915C8.2165 8.75 8.74984 8.275 8.74984 7.1Z" fill="#6366F1" class="dark:fill-purple-500 bg-opacity-75 p-4"/>
                        <path d="M8.74984 16.475V13.1083C8.74984 11.7833 8.2165 11.25 6.8915 11.25H3.52484C2.19984 11.25 1.6665 11.7833 1.6665 13.1083V16.475C1.6665 17.8 2.19984 18.3333 3.52484 18.3333H6.8915C8.2165 18.3333 8.74984 17.8 8.74984 16.475Z" fill="#6366F1" class="dark:fill-purple-500 bg-opacity-75 p-4"/>
                      </svg>
                <a href="#"><span>Dashboard</span></a>
            </div>
            <div class="flex flex-row gap-2 justify-center items-center bg-white rounded-3xl text-center text-xl ml-[21%] w-[15%] h-10 transition-transform duration-200 ease-out hover:scale-110">
                    <svg xmlns="http://www.w3.org/2000/svg" width="39" height="30" viewBox="0 0 33 27" fill="none">
                        <path d="M12.9551 17.4445H9.73242V18.7102H12.9551V17.4445Z" fill="#6366F1" class="dark:fill-purple-500 bg-opacity-75 p-4"/>
                        <path d="M23.2676 17.4445H20.0449V18.7102H23.2676V17.4445Z" fill="#6366F1" class="dark:fill-purple-500 bg-opacity-75 p-4"/>
                        <path d="M13.2939 8.04659C14.1412 8.42898 14.6471 9.05087 14.6471 9.71005C14.6471 9.99093 14.9961 10.2194 15.4252 10.2194C15.7056 10.2194 16.011 10.2194 16.1725 10.2194V6.79219H15.8556C15.6776 6.79219 15.5333 6.69773 15.5333 6.58125C15.5333 6.46477 15.6776 6.37032 15.8556 6.37032H16.1725V5.89043C16.1725 5.6012 15.813 5.36583 15.371 5.36583C14.9291 5.36583 14.5695 5.60115 14.5695 5.89043C14.5695 6.00691 14.4252 6.10137 14.2472 6.10137C14.0692 6.10137 13.9249 6.00691 13.9249 5.89043C13.9249 5.36853 14.5736 4.94396 15.3709 4.94396C15.8243 4.94396 16.2294 5.08132 16.4948 5.29567C16.76 5.08132 17.1651 4.94396 17.6185 4.94396C18.4158 4.94396 19.0645 5.36853 19.0645 5.89043C19.0645 6.00691 18.9202 6.10137 18.7422 6.10137C18.5642 6.10137 18.42 6.00691 18.42 5.89043C18.42 5.6012 18.0604 5.36583 17.6185 5.36583C17.1765 5.36583 16.817 5.60115 16.817 5.89043V6.37032H17.1446C17.3226 6.37032 17.4669 6.46477 17.4669 6.58125C17.4669 6.69773 17.3226 6.79219 17.1446 6.79219H16.817V10.2194C16.9791 10.2194 17.2849 10.2194 17.5658 10.2194C17.994 10.2194 18.3424 9.99135 18.3424 9.71106C18.3424 9.04509 18.8348 8.42886 19.6595 8.06267C21.2125 7.37311 22.1397 6.22924 22.1397 5.00272C22.1397 2.9511 19.5685 1.27926 16.4141 1.30815C13.3195 1.33638 10.8235 3.00814 10.8498 5.03483C10.8655 6.23696 11.7792 7.36286 13.2939 8.04659Z" fill="#6366F1" class="dark:fill-purple-500 bg-opacity-75 p-4"/>
                        <path d="M27.457 4.36641C28.3455 4.36641 29.0684 3.89328 29.0684 3.31172C29.0684 2.73017 28.3455 2.25703 27.457 2.25703C26.5685 2.25703 25.8457 2.73017 25.8457 3.31172C25.8457 3.89328 26.5685 4.36641 27.457 4.36641Z" fill="#6366F1" class="dark:fill-purple-500 bg-opacity-75 p-4"/>
                        <path d="M17.3856 11.5383C17.7634 11.5383 18.0708 11.3371 18.0708 11.0898C18.0708 10.8425 17.7634 10.6413 17.3856 10.6413H15.6032C15.2253 10.6413 14.918 10.8425 14.918 11.0898C14.918 11.3371 15.2253 11.5383 15.6032 11.5383H17.3856Z" fill="#6366F1" class="dark:fill-purple-500 bg-opacity-75 p-4"/>
                        <path d="M6.1875 4.36641C6.72059 4.36641 7.1543 4.08253 7.1543 3.7336C7.1543 3.38466 6.72059 3.10078 6.1875 3.10078C5.65441 3.10078 5.2207 3.38466 5.2207 3.7336C5.2207 4.08253 5.65441 4.36641 6.1875 4.36641Z" fill="#6366F1" class="dark:fill-purple-500 bg-opacity-75 p-4"/>
                        <path d="M22.6139 12.5281C22.6139 12.4116 22.4697 12.3172 22.2917 12.3172C22.1137 12.3172 21.9694 12.4116 21.9694 12.5281C21.9694 14.4191 19.7036 15.9697 16.8558 16.0793V14.7538C18.5888 14.6472 19.9496 13.6898 19.9496 12.5281C19.9496 12.4116 19.8053 12.3172 19.6273 12.3172C19.4493 12.3172 19.3051 12.4116 19.3051 12.5281C19.3051 13.5284 18.0618 14.3422 16.5336 14.3422C15.0077 14.3422 13.7663 13.5284 13.7663 12.5281C13.7663 12.4116 13.622 12.3172 13.4441 12.3172C13.2661 12.3172 13.1218 12.4116 13.1218 12.5281C13.1218 13.6898 14.4807 14.647 16.2113 14.7538V16.0793C13.3634 15.9697 11.0977 14.4192 11.0977 12.5281C11.0977 12.4116 10.9533 12.3172 10.7754 12.3172C10.5974 12.3172 10.4531 12.4116 10.4531 12.5281C10.4531 14.6518 13.0078 16.3924 16.2113 16.5024V18.2883H15.2109C15.0329 18.2883 14.8886 18.3827 14.8886 18.4992C14.8886 18.6157 15.0329 18.7102 15.2109 18.7102H17.789C17.967 18.7102 18.1113 18.6157 18.1113 18.4992C18.1113 18.3827 17.967 18.2883 17.789 18.2883H16.8558V16.5024C20.0594 16.3924 22.6139 14.6518 22.6139 12.5281Z" fill="#6366F1" class="dark:fill-purple-500 bg-opacity-75 p-4"/>
                        <path d="M8.76562 2.46797C9.12159 2.46797 9.41016 2.27909 9.41016 2.0461C9.41016 1.8131 9.12159 1.62422 8.76562 1.62422C8.40966 1.62422 8.12109 1.8131 8.12109 2.0461C8.12109 2.27909 8.40966 2.46797 8.76562 2.46797Z" fill="#6366F1" class="dark:fill-purple-500 bg-opacity-75 p-4"/>
                        <path d="M23.5898 2.0461C23.9458 2.0461 24.2344 1.85722 24.2344 1.62422C24.2344 1.39123 23.9458 1.20235 23.5898 1.20235C23.2339 1.20235 22.9453 1.39123 22.9453 1.62422C22.9453 1.85722 23.2339 2.0461 23.5898 2.0461Z" fill="#6366F1" class="dark:fill-purple-500 bg-opacity-75 p-4"/>
                        <path d="M24.8789 6.26485C25.2349 6.26485 25.5234 6.07597 25.5234 5.84297C25.5234 5.60998 25.2349 5.4211 24.8789 5.4211C24.5229 5.4211 24.2344 5.60998 24.2344 5.84297C24.2344 6.07597 24.5229 6.26485 24.8789 6.26485Z" fill="#6366F1" class="dark:fill-purple-500 bg-opacity-75 p-4"/>
                        <path d="M8.76562 7.53047C9.12159 7.53047 9.41016 7.34159 9.41016 7.1086C9.41016 6.8756 9.12159 6.68672 8.76562 6.68672C8.40966 6.68672 8.12109 6.8756 8.12109 7.1086C8.12109 7.34159 8.40966 7.53047 8.76562 7.53047Z" fill="#6366F1" class="dark:fill-purple-500 bg-opacity-75 p-4"/>
                        <path d="M26.168 8.37422V8.62207C26.5428 8.70923 26.8125 8.94308 26.8125 9.21797C26.8125 9.49287 26.5428 9.72671 26.168 9.81387V16.7107C27.4788 16.0011 29.3697 16.0016 30.6797 16.7107V8.37422C30.6797 7.56005 29.6677 6.89766 28.4238 6.89766C27.1799 6.89766 26.168 7.56005 26.168 8.37422Z" fill="#6366F1" class="dark:fill-purple-500 bg-opacity-75 p-4"/>
                        <path d="M6.83203 16.7107V9.81387C6.45717 9.72671 6.1875 9.49287 6.1875 9.21797C6.1875 8.94308 6.45717 8.70923 6.83203 8.62207V8.37422C6.83203 7.56005 5.82005 6.89766 4.57617 6.89766C3.33229 6.89766 2.32031 7.56005 2.32031 8.37422V16.7107C3.63097 16.0012 5.52202 16.0016 6.83203 16.7107Z" fill="#6366F1" class="dark:fill-purple-500 bg-opacity-75 p-4"/>
                        <path d="M9.41016 11.1164H12.6328C12.8108 11.1164 12.9551 11.022 12.9551 10.9055C12.9551 10.7889 12.8108 10.6945 12.6328 10.6945H9.41016C9.2322 10.6945 9.08789 10.7889 9.08789 10.9055C9.08789 11.022 9.2322 11.1164 9.41016 11.1164Z" fill="#6366F1" class="dark:fill-purple-500 bg-opacity-75 p-4"/>
                        <path d="M23.9121 10.9055C23.9121 10.7889 23.7679 10.6945 23.5898 10.6945H20.3672C20.1892 10.6945 20.0449 10.7889 20.0449 10.9055C20.0449 11.022 20.1892 11.1164 20.3672 11.1164H23.5898C23.7679 11.1164 23.9121 11.022 23.9121 10.9055Z" fill="#6366F1" class="dark:fill-purple-500 bg-opacity-75 p-4"/>
                        <path d="M28.4238 16.6008C26.8245 16.6008 25.5234 17.4524 25.5234 18.4992C25.5234 18.6157 25.6677 18.7102 25.8457 18.7102C26.0237 18.7102 26.168 18.6157 26.168 18.4992C26.168 17.685 27.1799 17.0227 28.4238 17.0227C29.6677 17.0227 30.6797 17.685 30.6797 18.4992C30.6797 19.3134 29.6677 19.9758 28.4238 19.9758C28.3422 19.9758 4.76238 19.976 4.57888 19.976C3.32823 19.976 2.32031 19.3112 2.32031 18.4992C2.32031 17.685 3.33229 17.0227 4.57617 17.0227C5.82005 17.0227 6.83203 17.685 6.83203 18.4992C6.83203 18.6157 6.97634 18.7102 7.1543 18.7102C7.33225 18.7102 7.47656 18.6157 7.47656 18.4992C7.47656 17.4524 6.17545 16.6008 4.57617 16.6008C2.9769 16.6008 1.67578 17.4524 1.67578 18.4992C1.67578 19.5417 2.9682 20.3977 4.58152 20.3977H28.4238C30.0231 20.3977 31.3242 19.5461 31.3242 18.4992C31.3242 17.4524 30.0231 16.6008 28.4238 16.6008Z" fill="#6366F1" class="dark:fill-purple-500 bg-opacity-75 p-4"/>
                        <path d="M12.3105 9.21797C12.3105 9.10149 12.1662 9.00703 11.9883 9.00703H7.1543C6.97634 9.00703 6.83203 9.10149 6.83203 9.21797C6.83203 9.33445 6.97634 9.42891 7.1543 9.42891H11.9883C12.1662 9.42891 12.3105 9.33445 12.3105 9.21797Z" fill="#6366F1" class="dark:fill-purple-500 bg-opacity-75 p-4"/>
                        <path d="M20.6895 9.21797C20.6895 9.33445 20.8337 9.42891 21.0117 9.42891H25.8457C26.0237 9.42891 26.168 9.33445 26.168 9.21797C26.168 9.10149 26.0237 9.00703 25.8457 9.00703H21.0117C20.8337 9.00703 20.6895 9.10149 20.6895 9.21797Z" fill="#6366F1" class="dark:fill-purple-500 bg-opacity-75 p-4"/>
                      </svg>
                    <a href="#"><span>Active Projects</span></a>
        </div>
        <div class="flex flex-row gap-2 justify-center items-center bg-white rounded-3xl text-center text-xl ml-[21%] w-[15%] h-10 transition-transform duration-200 ease-out hover:scale-110">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="25" viewBox="0 0 23 20" fill="none">
                <path d="M8.53943 2.32485C9.51236 1.89249 13.4876 1.89249 14.4606 2.32485V4H16V1.56747C16 0.527335 14.486 0 11.5 0C8.51404 0 7 0.527335 7 1.56747V4H8.53943V2.32485Z" fill="#6366F1" class="dark:fill-purple-500 bg-opacity-75 p-4"/>
                <path d="M22.012 4L11.4991 4.00158L0.988033 4C0.725751 4.00023 0.474318 4.08927 0.289031 4.24754C0.103744 4.40581 -0.000221312 4.62035 3.53736e-07 4.84397V12.3127L0.904287 12.9314V18H10.9539C10.9636 17.9283 10.9817 17.8576 11.0079 17.789C11.1215 17.4834 11.3724 17.2286 11.7057 17.0803C12.039 16.9319 12.4277 16.9021 12.7867 16.9974C12.6508 16.8038 12.5094 16.6008 12.3643 16.3914H2.79476V13.3185C3.67301 13.4438 4.7243 13.5406 5.86305 13.6152C7.56371 13.7231 9.26562 13.7818 10.9688 13.7913C11.0028 13.6369 11.0729 13.49 11.1749 13.3591C11.2768 13.2283 11.4086 13.1163 11.5623 13.0298C11.7087 12.9396 11.875 12.8756 12.0513 12.8418C12.2275 12.808 12.4099 12.805 12.5875 12.833C12.7651 12.8611 12.9342 12.9195 13.0845 13.0049C13.2348 13.0902 13.3633 13.2007 13.4621 13.3296C13.5793 13.4756 13.6928 13.6199 13.8045 13.7643C14.9153 13.7357 16.0261 13.686 17.137 13.6152C18.2757 13.5406 19.327 13.4438 20.2052 13.3185V16.3914H20.0155C20.2536 16.8054 20.5513 17.3321 20.9216 18H22.0957V12.9315L23 12.3127V4.84397C23.0002 4.62035 22.8963 4.40582 22.711 4.24755C22.5257 4.08928 22.2743 4.00023 22.012 4Z" fill="#6366F1" class="dark:fill-purple-500 bg-opacity-75 p-4"/>
                <path d="M18.8929 13.7555C18.8048 13.6684 18.692 13.6018 18.565 13.562C18.4381 13.5222 18.3013 13.5106 18.1677 13.5283C18.034 13.5459 17.9078 13.5923 17.8012 13.6629C17.6945 13.7335 17.6108 13.8261 17.5581 13.9318C17.4705 13.8748 17.3698 13.8339 17.2625 13.8117C17.1551 13.7895 17.0436 13.7865 16.9348 13.803C16.8261 13.8194 16.7226 13.8549 16.6309 13.9072C16.5392 13.9595 16.4614 14.0274 16.4024 14.1067L16.33 14.1062C15.9035 13.5245 14.9698 13.9554 15.0902 14.4926C14.5905 13.751 14.0517 13.0244 13.4672 12.2987C12.8764 11.5643 11.5636 12.3258 12.1533 13.0594C13.0599 14.4748 14.6644 16.6801 14.6644 16.6801L13.2112 16.0851C13.1022 16.0405 12.9832 16.0163 12.8623 16.0141C12.7413 16.0119 12.6212 16.0318 12.5101 16.0725C12.399 16.1131 12.2995 16.1735 12.2183 16.2497C12.1371 16.3258 12.0762 16.4159 12.0396 16.5137C11.9854 16.6586 11.9869 16.8143 12.0438 16.9584C12.1008 17.1025 12.2102 17.2275 12.3564 17.3153C13.291 17.8771 15.2886 19.0823 16.2754 19.7122C16.5357 19.8784 16.8472 19.9772 17.1721 19.9965C17.4971 20.0158 17.8217 19.9549 18.1068 19.8212L20.1278 18.8736C20.5032 18.6976 20.7856 18.4071 20.9178 18.0608C21.05 17.7146 21.022 17.3386 20.8395 17.0093C20.158 15.7791 19.1631 14.0227 18.8929 13.7555Z" fill="#6366F1" class="dark:fill-purple-500 bg-opacity-75 p-4"/>
            </svg>
...
const handleDeleteButtonClick = async(event) => {
    const id =
      ...
      deleteButtons.forEach((deleteButton) => deleteButton.addEventListener("click", handleDeleteModalTrigger));
      const editButtons = document.querySelectorAll(".editUser");
      modal && editButtons.forEach(editUserButton => {
...
const updateTable = async () => {
  try {
    ...
    initializeTable(responseData.content);
  } catch (error) {
    console.error(error);
  }
};

const dataTable = document.querySelector("#table_id");
updateTable();

//handle dashboard modal
const modal = document.querySelector(".modal__container");
const modalCreate = document.querySelector(".modal__container__create");
const modalDelete = document.querySelector(".modalDelete");
const closeBtn = document.querySelector(".modal__button__footer__close");
const closeCreateBtn = document.querySelector(".modal__button__footer__close__create");
const closeDeleteBtn = document.querySelector(".modal__button__footer__close__delete");
const headerCreateCloseBtn= document.querySelector(".modal__button__close__create");
const header = document.getElementsByTagName("nav")[0];
const headerCloseBtn = document.querySelector(".modal__button__close");
const headerDeleteCloseBtn = document.querySelector(".modal__button__close__delete");
const headerDeleteBtn = document.querySelector(".modal__button__close__delete");
const createProjectBtn = document.getElementById("addProject");

const createObscureDiv = () => {
  const div = document.createElement("div");
  div.classList.add("opacity-[100]", "transition-[0.3s]", "duration-[ease-in-out]");
  div.id = "opacity";
...
const postUserForm = document.querySelector("#postUserForm");

editUserForm.addEventListener("submit", (event) => event.preventDefault());
postUserForm.addEventListener("submit", (event) => event.preventDefault());
...
const handleEditSubmitEvent = async (id) => {
  await updateData(id);
  const updatedData = await fetchProjects();
  table.clear();
  table.rows.add(updatedData.content).draw();
...
const postData = async() => {
    const formData = new FormData(postUserForm);
      const jsonData = {};
      formData.forEach((value, key) => {
          jsonData[key] = value;
      });
...
const fetchID = (list,toFind, anchor, name) => {
  const foundItem = list.content.find((listItem) => listItem[anchor] === name);
  if (foundItem)
    return foundItem[toFind];
  return null;
}
...
const populateDropdowns = async () => {
  ...
  subCategories.content.forEach((subcategory) => {
    ...
    option.value = fetchID(subCategories, "sub_categoryID", "sub_categoryName", subcategory.sub_categoryName);
  ...
  categories.content.forEach((category) => {
    const option = document.createElement("option");
    option.value = fetchID(categories, "categoryID", "categoryName", category.categoryName);
  ...
  const option = document.createElement("option");
  option.value = fetchID(users, "userID", "username", user.username);
...
const selectOptions = async(userName, categoryName, sub_categoryName) => {
  const dropDowns = document.querySelectorAll("[data-users]");
  const dropDownsCategories = document.querySelectorAll("[data-categories]");
  const dropDownsSubCategories = document.querySelectorAll("[data-sub_categories]");

  for(let child of dropDownsSubCategories[0]) {
  ...
  for(let child of dropDownsCategories[0]) {
    if (child.hasAttribute("selected")) {
        child.removeAttribute("selected");
        break;
    }
  ...
  for (let child of dropDownsSubCategories[0]) {
    if (child.textContent === sub_categoryName)
...
const handleDeleteModalTrigger = (event) => {
  const deleteModal = document.querySelector(".modalDelete");
  const deleteBtn = document.querySelector(".deleteAction");
  deleteBtn.addEventListener("click", () => handleDeleteButtonClick(event));
  deleteModal.classList.add("-translate-x-2/4", "transform", "translate-y-[-18rem]", "opacity-[100]");
...
const handleModalClose = (event) => {
  ...
  modal.classList.remove("-translate-x-2/4", "transform", "translate-y-[-18rem]", "opacity-[100]");
  obscure.classList.remove('fixed', 'flex', 'justify-center', 'items-center', 'h-screen', 'w-screen', 'bg-[rgba(0,0,0,0.5)]', 'opacity-[50]', 'z-[5]', 'transition-[0.3s]', 'duration-[ease-in-out]', 'left-0', 'top-0');
  document.body.style.overflow = "visible";
};

const handleDeleteModalClose = (event) => {
  const target = event.target
  modalDelete.classList.remove("-translate-x-2/4", "transform", "translate-y-[-18rem]", "opacity-[100]");
  obscure.classList.remove('fixed', 'flex', 'justify-center', 'items-center', 'h-screen', 'w-screen', 'bg-[rgba(0,0,0,0.5)]', 'opacity-[50]', 'z-[5]', 'transition-[0.3s]', 'duration-[ease-in-out]', 'left-0', 'top-0');
  document.body.style.overflow = "visible";
};
...
const handleCreateModalTrigger = (event) => {
  ...
  obscure.classList.add('fixed', 'flex', 'justify-center', 'items-center', 'h-screen', 'w-screen', 'bg-[rgba(0,0,0,0.5)]', 'opacity-[50]', 'z-[5]', 'transition-[0.3s]', 'duration-[ease-in-out]', 'left-0', 'top-0');
  document.body.style.overflow = "hidden";
  const submitChangeBtn = document.querySelector(".submitChangeCreate");
  submitChangeBtn.addEventListener("click", handlePostSubmitEvent);
};

const handleCreateModalClose = (event) => {
  const target = event.target
  modalCreate.classList.remove("-translate-x-2/4", "transform", "translate-y-[-18rem]", "opacity-[100]");
  obscure.classList.remove('fixed', 'flex', 'justify-center', 'items-center', 'h-screen', 'w-screen', 'bg-[rgba(0,0,0,0.5)]', 'opacity-[50]', 'z-[5]', 'transition-[0.3s]', 'duration-[ease-in-out]', 'left-0', 'top-0');
  document.body.style.overflow = "visible";
};
...
if (modalCreate && createProjectBtn) {
    createProjectBtn.addEventListener("click", handleCreateModalTrigger)
    closeCreateBtn.addEventListener("click", handleCreateModalClose);
  obscure.addEventListener("click", handleCreateModalClose);
  headerCreateCloseBtn.addEventListener("click", handleCreateModalClose);
}

if (modalDelete) {
    closeDeleteBtn.addEventListener("click", handleDeleteModalClose);
  obscure.addEventListener("click", handleDeleteModalClose);
  headerDeleteCloseBtn.addEventListener("click", handleDeleteModalClose);
}
    </script>
</footer>
</body>
