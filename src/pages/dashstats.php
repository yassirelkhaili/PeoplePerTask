...
<body class="font-poppins dark:bg-gray-900 text-mainBlue dark:text-white">
    <section class="flex flex-row">
        ...
        <div class="text-white">
          Total Number of Projects: <span id="totalProjects"></span>
        </div>
        <div class="text-white">
          Total Number of Freelancers: <span id="totalFreelancers"></span>
        </div>
        <div class="text-white">
          Total Number of users: <span id="totalUsers"></span>
        </div>
<section class="text-black dark:text-white">
    <div class="py-[1%] px-[2%] ">
        <ul class="flex flex-col md:flex-row gap-5 ">
            <li class="flex flex-row border border-mainBlue w-[50%] md:w-[20%] h-24 px-[1%] rounded-2xl items-center mx-auto md:ml-[7%]">
...
<section class="flex flex-col md:flex-row items-center mt-[2%] mx-[2%]">
        <div class="w-[90%] md:w-[60%] border-2 rounded-3xl mb-4 md:mx-[2%] border-mainBlue p-[2%] dark:bg-indigo-950 dark:border-none">
            <h4 class="text-xl text-black dark:text-white">Analytics</h4>   
            <div  id="chart">
        </div>
        </div>
        <div class="w-[50%] md:w-[30%] border-2 rounded-3xl mx-[2%] border-mainBlue dark:bg-indigo-950 dark:border-none p-[2%]">
...
<section class="flex flex-col md:flex-row items-center text-black dark:text-white">
        <div class="w-[80%] md:w-[60%] border-2 p-[1%] rounded-3xl mx-[2%] border-mainBlue my-[2%] dark:bg-indigo-950 dark:border-none">
