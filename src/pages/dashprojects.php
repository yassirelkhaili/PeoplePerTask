...
const populateDropdowns = async (userID, categoryID, sub_categoryID) => {
  ...
  subCategories.content.forEach((subcategory) => {
    ...
    if (subcategory.sub_categoryID === parseInt(sub_categoryID))
...
populateDropdowns(content[inputs.length + 3].textContent, content[inputs.length + 2].textContent, content[inputs.length + 1].textContent);
let i;
if (select) {
  i = inputs.length - 1;
} else {
